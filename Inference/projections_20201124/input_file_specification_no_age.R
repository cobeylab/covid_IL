...
# all covariates
fraction_underreported_file='Data/2020-11-23_IL_underrerporting.csv'
nonhosp_deaths = 'Data/2020-10-24_IL_frac_deaths_nonhosp.csv'
population_file = 'Data/covid_region_populations.csv'
cli_file = 'Data/cli_admissions_2020-11-24.csv'
