...
export ncores=28
export maxjobs=250
sbatch ${partitionspec} --dependency=${job6##* } --array=1-14 --export=ALL 3.run_pfilter_around_mle.sbatch
sbatch -p broadwl-lc --dependency=${job6##* } --array=15-20 --export=ALL 3.run_pfilter_around_mle.sbatch
sbatch ${covidspec} --dependency=${job6##* } --array=21-50 --export=ALL 3.run_pfilter_around_mle.sbatch