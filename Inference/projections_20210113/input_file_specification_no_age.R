simend = '2021-01-11' # Set to last date in the EMR data
project_end = '2021-04-01'
project_zoom = as.Date('2020-03-01')
model_name = 'beta_hfr_mu_gamma_constphi_cdc'

## Data to fit
ll_file = 'Inference/projections_20210113_extrachangepoint/data/ll_deaths_20210112.csv'
emr_data_file = 'Inference/projections_20210113_extrachangepoint/data/emr_fit_long_20210112.csv'
emr_report = 'Inference/projections_20210113_extrachangepoint/data/emr_report_long_20210112.csv'
hosp_capacity_file = 'Inference/projections_20210113_extrachangepoint/data/capacity_weekday_average_20210112.csv'
debug.mif = F
start_fit_at_mle = T
simulate_new = T
...
beta_covariate = 'Inference/projections_20210113_extrachangepoint/data/beta_values_no_age.covar.cli_tpr.csv'
...
dmeasFile = 'Inference/projections_20210113_extrachangepoint/dmeasure_no_age.c'
init_file='Inference/projections_20210113_extrachangepoint/initializer_no_age.c'
rmeasFile = 'Inference/projections_20210113_extrachangepoint/rmeasure_no_age.c'
rprocFile = 'Inference/projections_20210113_extrachangepoint/rprocess_no_age_changepoint.c'
function_file='Inference/projections_20210113_extrachangepoint/simulation_functions_no_age.R'

# all covariates
fraction_underreported_file='internal_data/2020-12-10_IL_underrerporting.csv'
nonhosp_deaths = 'internal_data/2020-10-24_IL_frac_deaths_nonhosp.csv'
population_file = 'Data/covid_region_populations.csv'
cli_file = 'internal_data/cli_admissions_2020-12-15.csv'
