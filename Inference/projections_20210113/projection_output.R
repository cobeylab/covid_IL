...
alloutputs = read.csv(sprintf("%s/full_projection_%s_%s.csv", human_output_dir, model_name, region_to_test))
alloutputs = process_pomp_covid_output(alloutputs, agg_regions=F)$plotting_output
projections =  alloutputs %>%  
