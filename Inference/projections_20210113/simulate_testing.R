...
# Reset parameter values for testing
  pars[['n_changepoints_11']] = 8

  pars[['changepoints_1_11']] =  60
  pars[['changepoints_2_11']] = 66
  pars[['changepoints_3_11']] = convert_date_to_time('2020-04-06', t_ref)
  pars[['changepoints_4_11']] = convert_date_to_time('2020-05-21', t_ref)
  pars[['changepoints_5_11']] = convert_date_to_time('2020-06-28', t_ref)
  pars[['changepoints_6_11']] = convert_date_to_time('2020-08-29', t_ref)
  pars[['changepoints_7_11']] = convert_date_to_time('2020-10-18', t_ref)
  pars[['changepoints_8_11']] = convert_date_to_time('2020-11-09', t_ref)

  print(pars[paste0('changepoints_', 1:8, '_', 11)])
  pars[['beta_values_1_11']] = 0.1
  pars[['beta_values_2_11']] = 0.3
  pars[['beta_values_3_11']] = 0.22
  pars[['beta_values_4_11']] = 0.2
  pars[['beta_values_5_11']] = 0.22
  pars[['beta_values_6_11']] = 0.2
  pars[['beta_values_7_11']] = 0.57
  pars[['beta_values_8_11']] = 0.22

  pars[['inv_gamma_f_11']] = 0.5
...
plotout_noage = bind_rows(plotout_noage, gamma_df) %>% bind_rows(mu_df) %>% bind_rows(phidf) %>%
  filter(Date >= as.Date('2020-08-20'), Date<=as.Date('2020-10-01'))
...
ggplot(plotout_noage, aes(x=Date, y=Cases, color=Source, fill=Source)) +
   ...
   #geom_line(plotting_data %>% filter(Date >= as.Date('2020-08-20'), Date<=as.Date('2020-10-20')), mapping=aes(x=Date, y=Cases, fill=Source), size=0.9, alpha=0.7, pch=21) +
