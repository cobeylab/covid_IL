...
for (int region=0; region<n_regions; region += 1){
      ...
      initialize_state(region, alpha_E_int, Evar);
      initialize_state(region, alpha_P_int, Pvar);
      initialize_state(region, alpha_IM_int, IMvar);
      initialize_state(region, alpha_IM_int, IM_deadvar);
      initialize_state(region, alpha_IS_int, ISvar);
