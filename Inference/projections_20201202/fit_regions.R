...
rw_sd_str = do.call(sprintf, c(fmt="%s=ivp(0.05), %s=0.02, %s=ifelse(time<=147, 0.02, 0), %s=ifelse(time>=117, 0.02, 0), %s=ifelse(time<=147, 0.02, 0), %s=ifelse(time>=117, 0.02, 0), %s=ifelse(time<=147, 0.02, 0), %s=ifelse(time>=117, 0.02, 0)", as.list(pars_to_fit)))
