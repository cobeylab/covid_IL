...
if (use_mle == T){
  ...
  pars[['beta_values_12_8']] = pars[['beta_values_12_8']] * 0.95
  pars[['beta_values_13_8']] = pars[['beta_values_13_8']] * 1.1
  pars[['beta_values_14_8']] = pars[['beta_values_14_8']] * 1.5  
  pars[['changepoints_12_8']] = 284
  pars[['changepoints_13_8']] = 296
  #pars[['changepoints_8_10']] = 315
  #pars[['changepoints_14_10']] = 301
  #pars[['changepoints_15_10']] = 311

  pars[['beta_values_15_10']] = 311
...
ggplot(plotout_noage, aes(x=Date, y=Cases, color=Source, fill=Source)) +
   ...
   xlim(as.Date('2020-10-01'), Sys.Date())
