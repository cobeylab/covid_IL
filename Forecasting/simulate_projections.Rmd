...
end_forecast_hub_date <- as.Date("2020-06-27")
...
scenarios=c(100, 10, 30)
scales = list(c(1, 1, 1, 1), c(1.18, 1.26, 1.22, 1.28), c(1.54, 1.78, 1.66, 1.84)) # Scenarios for scaling of post-intervention beta
...
output_path = "./forecast_20200425/" # where to access the result files 
plot_filename <- "4reg.outputs.png"
reg_hosp_cap = read.csv('idph_cluster_capacities.csv')
intervention_scenarios <- c("100", "10", "30")
this_date <- "May 22, 2020" # Specify the last date of data used for inference
