...
end_projection_date <- as.Date("2020-06-13")
...
intervention_lift_date <- as.Date("2020-05-29") # this is the date at which any relaxation of intervention begins
...
output_path = "./sim_projections/statewide/" # where to access the result files 
...
foreach (i=1:length(compartments)) %do%{
    matrix(pomp_contacts[[compartments[i]]][162:242], nrow=9, ncol=9)
} -> contacts3
