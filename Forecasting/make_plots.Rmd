...
last_date = as.Date('2021-01-14')
first_date = as.Date('2020-03-01')
last_plot_date = last_date + 30
fit_results = './latest_fit_results/uchicago_github_20210114.csv'
...
foreach(r=1:11, .combine='rbind') %do%{
    read.csv(sprintf("model_rt_estimates/model_rt_%s_2021-01-12.csv", r)) %>%
        mutate(date =as.Date(date))
} -> rt_model
