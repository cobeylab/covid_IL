...
last_date = as.Date('2021-01-19')
first_date = as.Date('2020-03-01')
last_plot_date = last_date + 30
fit_results = './latest_fit_results/uchicago_github_20210120.csv'
cdc_hosp_file = '../Data/reported_hospital_utilization_timeseries_20210118_1604.csv'
...
foreach(r=1:11, .combine='rbind') %do%{
    read.csv(sprintf("model_rt_estimates/model_rt_%s_%s.csv", r, last_date)) %>%
        mutate(date =as.Date(date))
} -> rt_model
